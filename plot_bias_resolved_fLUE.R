...
pdf("fig/bias_resolved_fLUE.pdf", width = 7, height = 6)

  par(las=1)
  myboxplot( bias_diff ~ infbin, data = tmp, at=(bins[1:nbins]+1/nbins*space-0.02), xlab = "fLUE bin", ylab = expression( paste("bias (gC m"^-2, "d"^-1, ")" ) ), ylim=c(-6,6), col="tomato", boxwex=0.05, xlim=c(-0.05,0.95) )
  myboxplot( bias_diff_corr ~ infbin, data = tmp0, at=(bins[1:nbins]+1/nbins*space+0.03), add=TRUE, col="royalblue3", axes=FALSE, boxwex=0.05 )
...
pdf("fig/bias_pmodel_resolved_fLUE.pdf", width = 7, height = 6)

  par(las=1)
  myboxplot( bias_pmodel_diff ~ infbin, data = df_dday_8d_agg_norm, at=(bins[1:nbins]+1/nbins*space-0.02), xlab = "fLUE bin", ylab = expression( paste("bias (gC m"^-2, "d"^-1, ")" ) ), ylim=c(-6,6), col="tomato", boxwex=0.05, xlim=c(-0.05,0.95) )
  myboxplot( bias_pmodel_diff_corr ~ infbin, data = df_dday_8d_agg_norm, at=(bins[1:nbins]+1/nbins*space+0.03), add=TRUE, col="royalblue3", axes=FALSE, boxwex=0.05 )
...
pdf("fig/bias_rmodis_esolved_fLUE.pdf", width = 7, height = 6)

  par(las=1)
  myboxplot( bias_modis_diff ~ infbin, data = df_dday_8d_agg_norm, at=(bins[1:nbins]+1/nbins*space-0.02), xlab = "fLUE bin", ylab = expression( paste("bias (gC m"^-2, "d"^-1, ")" ) ), ylim=c(-6,6), col="tomato", boxwex=0.05, xlim=c(-0.05,0.95) )
  myboxplot( bias_modis_diff_corr ~ infbin, data = df_dday_8d_agg_norm, at=(bins[1:nbins]+1/nbins*space+0.03), add=TRUE, col="royalblue3", axes=FALSE, boxwex=0.05 )
...
pdf("fig/bias_vpm_resolved_fLUE.pdf", width = 7, height = 6)

  par(las=1)
  myboxplot( bias_vpm_diff ~ infbin, data = df_dday_8d_agg_norm, at=(bins[1:nbins]+1/nbins*space-0.02), xlab = "fLUE bin", ylab = expression( paste("bias (gC m"^-2, "d"^-1, ")" ) ), ylim=c(-6,6), col="tomato", boxwex=0.05, xlim=c(-0.05,0.95) )
  myboxplot( bias_vpm_diff_corr ~ infbin, data = df_dday_8d_agg_norm, at=(bins[1:nbins]+1/nbins*space+0.03), add=TRUE, col="royalblue3", axes=FALSE, boxwex=0.05 )
...
pdf("fig/bias_bess_v1_resolved_fLUE.pdf", width = 7, height = 6)

  par(las=1)
  myboxplot( bias_bess_v1_diff ~ infbin, data = df_dday_8d_agg_norm, at=(bins[1:nbins]+1/nbins*space-0.02), xlab = "fLUE bin", ylab = expression( paste("bias (gC m"^-2, "d"^-1, ")" ) ), ylim=c(-6,6), col="tomato", boxwex=0.05, xlim=c(-0.05,0.95) )
  myboxplot( bias_bess_v1_diff_corr ~ infbin, data = df_dday_8d_agg_norm, at=(bins[1:nbins]+1/nbins*space+0.03), add=TRUE, col="royalblue3", axes=FALSE, boxwex=0.05 )
