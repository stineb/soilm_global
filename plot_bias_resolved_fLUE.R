...
##------------------------------------------------
bybin_orig <- tmp  %>% group_by( infbin ) %>% summarise( bias = mean(bias_diff, na.rm=TRUE), rmse = rmse( bias_diff + gpp_obs, gpp_obs) )
bybin_corr <- tmp0 %>% group_by( infbin ) %>% summarise( bias = mean(bias_diff_corr, na.rm=TRUE), rmse = rmse( bias_diff_corr + gpp_obs, gpp_obs) )
bybin_cor4 <- tmp4 %>% group_by( infbin ) %>% summarise( bias = mean(bias_diff_corr_IV, na.rm=TRUE), rmse = rmse( bias_diff_corr_IV + gpp_obs, gpp_obs) )
...
if (makepdf) pdf("fig/bias_resolved.pdf", width = 7, height = 6)
  par(xaxs="i", yaxs="i", mgp=c(2.5,1,0), las=1)
  plot( xlim, ylim, type="n", ylim=ylim, xlim=xlim, xlab = "fLUE bin", ylab = expression( paste("bias (gC m"^-2, "d"^-1, ")" ) ), axes=FALSE )
  rect( 1:5-0.5, rep(ylim[1], 6), 1:5+0.5, rep(ylim[2], 6), border = NA, col=colorRampPalette( c("wheat3", "white") )( 5 ) )
  ...
  legend("bottomleft", 
    ...
    fill=c("tomato", "royalblue3", "springgreen1", "springgreen3", "springgreen4"), bty="n")
if (makepdf) dev.off()

## pmodel
if (makepdf) pdf("fig/bias_pmodel_resolved_fLUE.pdf", width = 7, height = 6)
  par(xaxs="i", yaxs="i", mgp=c(2.5,1,0), las=1)
  plot( xlim, ylim, type="n", ylim=ylim, xlim=xlim, xlab = "fLUE bin", ylab = expression( paste("bias (gC m"^-2, "d"^-1, ")" ) ), axes=FALSE )
  rect( 1:5-0.5, rep(ylim[1], 6), 1:5+0.5, rep(ylim[2], 6), border = NA, col=colorRampPalette( c("wheat3", "white") )( 5 ) )
...
## modis
if (makepdf) pdf("fig/bias_modis_esolved_fLUE.pdf", width = 7, height = 6)
  par(xaxs="i", yaxs="i", mgp=c(2.5,1,0), las=1)
  plot( xlim, ylim, type="n", ylim=ylim, xlim=xlim, xlab = "fLUE bin", ylab = expression( paste("bias (gC m"^-2, "d"^-1, ")" ) ), axes=FALSE )
  rect( 1:5-0.5, rep(ylim[1], 6), 1:5+0.5, rep(ylim[2], 6), border = NA, col=colorRampPalette( c("wheat3", "white") )( 5 ) )
...
## vpm
if (makepdf) pdf("fig/bias_vpm_resolved_fLUE.pdf", width = 7, height = 6)
  par(xaxs="i", yaxs="i", mgp=c(2.5,1,0), las=1)
  plot( xlim, ylim, type="n", ylim=ylim, xlim=xlim, xlab = "fLUE bin", ylab = expression( paste("bias (gC m"^-2, "d"^-1, ")" ) ), axes=FALSE )
  rect( 1:5-0.5, rep(ylim[1], 6), 1:5+0.5, rep(ylim[2], 6), border = NA, col=colorRampPalette( c("wheat3", "white") )( 5 ) )
...
## bess
if (makepdf) pdf("fig/bias_bess_v1_resolved_fLUE.pdf", width = 7, height = 6)
  par(xaxs="i", yaxs="i", mgp=c(2.5,1,0), las=1)
  plot( xlim, ylim, type="n", ylim=ylim, xlim=xlim, xlab = "fLUE bin", ylab = expression( paste("bias (gC m"^-2, "d"^-1, ")" ) ), axes=FALSE )
  rect( 1:5-0.5, rep(ylim[1], 6), 1:5+0.5, rep(ylim[2], 6), border = NA, col=colorRampPalette( c("wheat3", "white") )( 5 ) )
...
## mte
if (makepdf) pdf("fig/bias_mte_resolved_fLUE.pdf", width = 7, height = 6)
  par(xaxs="i", yaxs="i", mgp=c(2.5,1,0), las=1)
  plot( xlim, ylim, type="n", ylim=ylim, xlim=xlim, xlab = "fLUE bin", ylab = expression( paste("bias (gC m"^-2, "d"^-1, ")" ) ), axes=FALSE )
  rect( 1:5-0.5, rep(ylim[1], 6), 1:5+0.5, rep(ylim[2], 6), border = NA, col=colorRampPalette( c("wheat3", "white") )( 5 ) )
