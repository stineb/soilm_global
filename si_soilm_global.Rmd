...
```
![Bias of simulated daily GPP by models, in different fLUE bins, calculated as simulated GPP minus observed GPP, derived from flux measurements at 36 sites. Data is normalised to the median ratio of modelled over observed GPP in the highest fLUE bin (0.8-1.0).](./fig/bias_bymodels_norm.pdf){ width=65% }
...
```
![Spatial/annual](./fig/modobs_ann_spatial_temporal_pmodel_s0.pdf){ width=75% }

![Spatial/annual, corrected](./fig/modobs_ann_spatial_temporal_pmodel_s1b.pdf){ width=75% }
