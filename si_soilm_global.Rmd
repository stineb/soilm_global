...
plot_map( gpp_s1 - gpp_s0, lev=seq(-5000,13000,2000), minval=-169000, maxval=83000, toplefttext=expression(paste("")), toprighttext=expression(paste("g C m"^-2, " yr"^-1 ) ), color=c( "royalblue4", "wheat", "tomato2", "tomato4" )  )
...
par(las=1)
myboxplot( ampl ~ inbin, data = df, ylim=c(0,5.5), outline=FALSE, 
