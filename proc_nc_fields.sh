...
get_trend_effect () {
	...
	##-----------------------------
	## argument 1: base file name of simulation without soil moisture effect
	## argument 2: base file name of simulation with soil moisture effect
	##-----------------------------
	echo "----------------------------"
	echo "getting trend of soil moisture effect for $2 ..."
	echo "----------------------------"

	## get difference
	cdo sub -selyear,1982/2016 -selname,gpp $2_ANN.nc $1_ANN.nc $2_ANN_SMDIFF.nc

	## detrend at each gridcell
	cdo trend $2_ANN_SMDIFF.nc $2_TREND_INSCT.nc $2_TREND_SLOPE.nc

	## get slope normalised by mean
	cdo div $2_TREND_SLOPE.nc $2_TREND_INSCT.nc $2_TREND_SLOPE_NORM.nc
