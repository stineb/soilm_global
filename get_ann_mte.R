...
for (year in yearstart:yearend){
  ...
  idx <- idx + 1
  filn <- paste0( "/Users/benjaminstocker/data/gpp_mte/GPP.RF.CRUNCEPv6.annual.", as.character(year), ".nc" )
...
## write annual GPP to file
outfilnam <- paste0("/Users/benjaminstocker/data/gpp_mte/gpp_mte_fluxcom_ann.nc")
cdf.write( gpp, "gpp", 
           lon, lat,
           filnam = outfilnam,
           nvars = 1,
