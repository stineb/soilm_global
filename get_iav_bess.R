...
fil <- "/Users/benjaminstocker/data/gpp_bess/gpp_bess_ann.nc"
...
write.csv( df, file=paste0( "data/bess_globaltotal.csv" ), row.names=FALSE )
save( df, file=paste0( "data/bess_globaltotal.Rdata" ) )

print(paste("Model, range of global GPP: MTE  ", range(ggpp)))

## store nice and unified GPP
print("save nice file")
outfilnam <- "/Users/benjaminstocker/data/gpp_bess/BESS_nice.nc"
...
cdf.write( gpp_detr, "gpp", 
           lon, lat,
           filnam = "/Users/benjaminstocker/data/gpp_bess/BESS_detr.nc",
           nvars = 1,
           time = time,
           make.tdim = TRUE,
           units_time = "year",
...
cdf.write( gpp_var, "gpp", 
           lon, lat,
           filnam = "/Users/benjaminstocker/data/gpp_bess/BESS_var.nc",
           nvars = 1,
           make.tdim = FALSE,
           long_name_var1 = "Gross primary productivity",
           units_var1 = "gC m-2 year-1"
...
cdf.write( gpp_mean, "gpp", 
           lon, lat,
           filnam = "/Users/benjaminstocker/data/gpp_bess/BESS_mean.nc",
           nvars = 1,
           make.tdim = FALSE,
           long_name_var1 = "Gross primary productivity",
           units_var1 = "gC m-2 year-1"
...
cdf.write( gpp_relvar, "gpp", 
           lon, lat,
           filnam = "/Users/benjaminstocker/data/gpp_bess/BESS_relvar.nc",
           nvars = 1,
           make.tdim = FALSE,
           long_name_var1 = "Gross primary productivity",
           units_var1 = "(unitless)"
