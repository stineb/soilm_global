...
```{r plot_ahlstroem, echo=FALSE, warning=FALSE}
source("plot_ahlstroem.R")
```

Do the same analysis as in Jung et al. (2017), illustrating the scale-dependence of the soil moisture effect on GPP variance.
