...
ddf <- ddf %>%  mutate( flue_est_1 = calc_flue_est_alpha( soilm_mean, alpha=meanalpha, apar=coef(linearfit1$linmod)[1], bpar=coef(linearfit1$linmod)[2], cpar=0.125, dpar=0.75 ) ) %>% 
                          mutate( bias_pmodel_diff = gpp_pmodel - gpp_obs,
                                  bias_pmodel_diff_corr = gpp_pmodel * fvar - gpp_obs,
                                  bias_pmodel_diff_corr_e1 = gpp_pmodel * flue_est_1 - gpp_obs
                                 )
...
bp2 <- boxplot( bias_pmodel_diff_corr_e1 ~ inbin, data=ddf, col="springgreen3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.3), boxwex=0.03, xlim=c(0,1), axes=FALSE, staplewex=0, whisklty=1, ylim=c(-6,6) )
...
ddf <- ddf %>%  mutate( flue_est_2 = stress_quad_1sided_alpha( soilm_mean, meanalpha, x0_fix, coef(linearfit2$linmod)[["(Intercept)"]], coef(linearfit2$linmod)[["meanalpha"]] ) ) %>% 
                mutate( bias_pmodel_diff_corr_e2 = gpp_pmodel * flue_est_2 - gpp_obs )

## Bias (difference), correction by fLUE directly, fLUE bins
bp1 <- boxplot( bias_pmodel_diff ~ inbin, data=ddf, col="tomato", las=1, outline = FALSE, na.rm=TRUE, add=FALSE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.1), boxwex=0.03, xlim=c(0,1), xlab="soilm moisture bins", ylab="bias (mod.-obs.)", staplewex=0, whisklty=1, ylim=c(-6,6) )
bp2 <- boxplot( bias_pmodel_diff_corr_e2 ~ inbin, data=ddf, col="springgreen3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.3), boxwex=0.03, xlim=c(0,1), axes=FALSE, staplewex=0, whisklty=1, ylim=c(-6,6) )
bp3 <- boxplot( bias_pmodel_diff_corr ~ inbin, data=ddf, col="springgreen4", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.5), boxwex=0.03, xlim=c(0,1), axes=FALSE, staplewex=0, whisklty=1, ylim=c(-6,6) )
abline( h=0.0, lty=3 )
...
## Use fixed point (soil moisture) above which stress function is 1 (no stress)
x0_fix <- 0.9
notorious <- c("IT-Noe", "FR-Pue", "AU-Stp", "AU-Fog", "AU-DaP", "AU-ASM", "IT-SRo", "US-SRG", "US-SRM") 
linearfit3 <- get_linearfit2( filter( ddf, dday>=0, mysitename %in% notorious ), target="ratio_obs_mod_pmodel", monthly=FALSE, bin=FALSE, x0_fix=x0_fix, useweights = TRUE, doplot = FALSE )
...
ddf <- ddf %>%  mutate( flue_est_3 = stress_quad_1sided_alpha( soilm_mean, meanalpha, x0_fix, coef(linearfit3$linmod)[["(Intercept)"]], coef(linearfit3$linmod)[["meanalpha"]] ) ) %>% 
                mutate( bias_pmodel_diff_corr_e2 = gpp_pmodel * flue_est_3 - gpp_obs )
...
<!-- ### Linearfit III: Exponential stress function -->
...
<!-- binwidth <- 1/nbins -->
<!-- bins <- seq( from=0, to=1, by=binwidth ) -->
<!-- ddf <- ddf %>% mutate( inbin = cut( as.numeric(fvar), breaks = bins ), insoilmbin = cut( as.numeric(soilm_mean), breaks = bins ) ) -->
...
<!-- bp1 <- boxplot( log( bias_pmodel ) ~ inbin, data=ddf, col="tomato", las=1, outline = FALSE, na.rm=TRUE, add=FALSE, at=(bins[1:nbins]+1/nbins*0.3), boxwex=0.05, xlim=c(0,1), ylab="log of mod./obs.", xlab="soilm moisture bins", staplewex=0, whisklty=1  ) -->
<!-- bp4 <- boxplot( log( bias_pmodel * flue_est_5 ) ~ inbin, data=ddf, col="springgreen3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, at=(bins[1:nbins]+1/nbins*0.7), boxwex=0.05, axes=FALSE, xlim=c(0,1), staplewex=0, whisklty=1 ) -->
<!-- abline( h=0.0, lty=3 ) -->
<!-- legend("bottomleft", c("P-model", "P-model, corrected"), bty="n", fill=c("tomato", "springgreen3") ) -->
<!-- ``` -->
...
## add estimated fLUE to ddf
ddf <- ddf %>% mutate( flue_est_4 = stress_quad_1sided_alpha( soilm_mean, meanalpha, x0_fix, apar, bpar, classid ) ) %>% 
               mutate( bias_pmodel_diff_corr_e4 = gpp_pmodel * flue_est_4 - gpp_obs )

## Bias (difference), correction by fLUE directly, fLUE bins
bp1 <- boxplot( bias_pmodel_diff ~ inbin, data=ddf, col="tomato", las=1, outline = FALSE, na.rm=TRUE, add=FALSE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.1), boxwex=0.03, xlim=c(0,1), xlab="soilm moisture bins", ylab="bias (mod.-obs.)", staplewex=0, whisklty=1, ylim=c(-6,6) )
bp2 <- boxplot( bias_pmodel_diff_corr_e4 ~ inbin, data=ddf, col="springgreen3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.3), boxwex=0.03, xlim=c(0,1), axes=FALSE, staplewex=0, whisklty=1, ylim=c(-6,6) )
bp3 <- boxplot( bias_pmodel_diff_corr ~ inbin, data=ddf, col="springgreen4", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.5), boxwex=0.03, xlim=c(0,1), axes=FALSE, staplewex=0, whisklty=1, ylim=c(-6,6) )
abline( h=0.0, lty=3 )
...
<!-- plot_fit_vs_soilmoist( linearfit1, linearfit6, linearfit3, ddf, nice_agg, makepdf = TRUE ) -->
<!-- ``` -->
...
df_dday_8d_agg <- df_dday_8d_agg %>% as_tibble() %>%
                                     mutate(  
                                              ...
                                              bias_modis_diff_corr_e1   = gpp_modis   * flue_est_1 - gpp_obs,
                                              bias_vpm_diff_corr_e1     = gpp_vpm     * flue_est_1 - gpp_obs, 
                                              bias_bess_v1_diff_corr_e1 = gpp_bess_v1 * flue_est_1 - gpp_obs, 
                                              bias_pmodel_diff_corr_e1  = gpp_pmodel  * flue_est_1 - gpp_obs,

                                              bias_modis_diff_corr_e2   = gpp_modis   * flue_est_2 - gpp_obs,
                                              bias_vpm_diff_corr_e2     = gpp_vpm     * flue_est_2 - gpp_obs, 
                                              bias_bess_v1_diff_corr_e2 = gpp_bess_v1 * flue_est_2 - gpp_obs, 
                                              bias_pmodel_diff_corr_e2  = gpp_pmodel  * flue_est_2 - gpp_obs,

                                              bias_modis_diff_corr_e3   = gpp_modis   * flue_est_3 - gpp_obs,
                                              bias_vpm_diff_corr_e3     = gpp_vpm     * flue_est_3 - gpp_obs, 
                                              bias_bess_v1_diff_corr_e3 = gpp_bess_v1 * flue_est_3 - gpp_obs, 
                                              bias_pmodel_diff_corr_e3  = gpp_pmodel  * flue_est_3 - gpp_obs
                                            )
...
# with( df_dday_8d_agg, heatscatter( fvar, bias_pmodel_diff_corr_e3, ylim = c(-6,6), xlim = c(0,1.2) ) )
# abline( h=0, lty=3 )
...
## pmodel
boxplot( bias_pmodel_diff_corr_e2 ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-6,6) )
abline( h=0, lty=3 )
mtext( "P-model, norm., corr. II", line=0.5, adj = 0, font=2 )

## MODIS
boxplot( bias_modis_diff_corr_e2 ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-6,6) )
abline( h=0, lty=3 )
mtext( "MODIS, norm., corr. II", line=0.5, adj = 0, font=2 )

## vpm
boxplot( bias_vpm_diff_corr_e2 ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-6,6) )
abline( h=0, lty=3 )
mtext( "VPM, norm., corr. II", line=0.5, adj = 0, font=2 )

## bess_v1
boxplot( bias_bess_v1_diff_corr_e2 ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-6,6) )
abline( h=0, lty=3 )
...
##------------------------------------------------
pmodel <- df_dday_8d_agg %>%  select( mysitename, date, inbin, bias_pmodel_diff_corr_e1, bias_pmodel_diff_corr_e2, bias_pmodel_diff_corr_e3 ) %>%
                              gather( fct, pmodel, bias_pmodel_diff_corr_e1, bias_pmodel_diff_corr_e2, bias_pmodel_diff_corr_e3 )

modis <- df_dday_8d_agg %>%  select( mysitename, date, inbin, bias_modis_diff_corr_e1, bias_modis_diff_corr_e2, bias_modis_diff_corr_e3 ) %>%
                             gather( fct, modis, bias_modis_diff_corr_e1, bias_modis_diff_corr_e2, bias_modis_diff_corr_e3 )

vpm <- df_dday_8d_agg %>%  select( mysitename, date, inbin, bias_vpm_diff_corr_e1, bias_vpm_diff_corr_e2, bias_vpm_diff_corr_e3 ) %>%
                           gather( fct, vpm, bias_vpm_diff_corr_e1, bias_vpm_diff_corr_e2, bias_vpm_diff_corr_e3 )

bess_v1 <- df_dday_8d_agg %>%  select( mysitename, date, inbin, bias_bess_v1_diff_corr_e1, bias_bess_v1_diff_corr_e2, bias_bess_v1_diff_corr_e3 ) %>%
                               gather( fct, bess_v1, bias_bess_v1_diff_corr_e1, bias_bess_v1_diff_corr_e2, bias_bess_v1_diff_corr_e3 )
...
tmp1 <- df_dday_8d_agg %>%  select( mysitename, date, fvar, inbin, bias_modis_diff_corr_e1, bias_vpm_diff_corr_e1, bias_bess_v1_diff_corr_e1, bias_pmodel_diff_corr_e1 ) %>% 
                            gather( model, bias_diff_corr_e1, bias_modis_diff_corr_e1, bias_vpm_diff_corr_e1, bias_bess_v1_diff_corr_e1, bias_pmodel_diff_corr_e1 )

tmp2 <- df_dday_8d_agg %>%  select( mysitename, date, fvar, inbin, bias_modis_diff_corr_e2, bias_vpm_diff_corr_e2, bias_bess_v1_diff_corr_e2, bias_pmodel_diff_corr_e2 ) %>% 
                            gather( model, bias_diff_corr_e2, bias_modis_diff_corr_e2, bias_vpm_diff_corr_e2, bias_bess_v1_diff_corr_e2, bias_pmodel_diff_corr_e2 )

tmp3 <- df_dday_8d_agg %>%  select( mysitename, date, fvar, inbin, bias_modis_diff_corr_e3, bias_vpm_diff_corr_e3, bias_bess_v1_diff_corr_e3, bias_pmodel_diff_corr_e3 ) %>% 
                            gather( model, bias_diff_corr_e3, bias_modis_diff_corr_e3, bias_vpm_diff_corr_e3, bias_bess_v1_diff_corr_e3, bias_pmodel_diff_corr_e3 )
...
boxplot( bias_diff_corr_e1 ~ inbin, data = tmp1, outline=FALSE, ylim=c(-7,7), xlab = "fLUE bin", ylab = "ratio obs./mod." )
abline( h=0, lty=3 )
mtext( "Pooled models, norm., corr. I", line=0.5, adj = 0, font=2 )

boxplot( bias_diff_corr_e2 ~ inbin, data = tmp2, outline=FALSE, ylim=c(-7,7), xlab = "fLUE bin", ylab = "ratio obs./mod." )
abline( h=0, lty=3 )
mtext( "Pooled models, norm., corr. II", line=0.5, adj = 0, font=2 )

boxplot( bias_diff_corr_e3 ~ inbin, data = tmp3, outline=FALSE, ylim=c(-7,7), xlab = "fLUE bin", ylab = "ratio obs./mod." )
abline( h=0, lty=3 )
