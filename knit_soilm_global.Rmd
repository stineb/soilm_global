...
ddf <- ddf %>% mutate( flue_est_2step = calc_flue_est_alpha( soilm_mean, alpha=meanalpha, apar=coef(linearfit$linmod)[1], bpar=coef(linearfit$linmod)[2], cpar=0.125, dpar=0.75 ) )
...
bp <- boxplot( log( bias_pmodel * flue_est_2step ) ~ insoilmbin, data=ddf, col="royalblue3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, at=(soilmbins[1:nbins]+1/nbins*0.6), boxwex=0.03, axes=FALSE, xlim=c(0,1) )
abline( h=0.0, lty=3 )
```
...
## add estimated fLUE to ddf
ddf <- ddf %>% mutate( flue_est_nls = stress_quad_1sided_alpha( soilm_mean, meanalpha, coef(nlsfit)[[ "x0" ]], coef(nlsfit)[[ "apar" ]], coef(nlsfit)[[ "bpar" ]] ) )
...
bp <- boxplot( log( bias_pmodel * flue_est_2step ) ~ insoilmbin, data=ddf, col="royalblue3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, at=(soilmbins[1:nbins]+1/nbins*0.6), boxwex=0.03, axes=FALSE, xlim=c(0,1) )
bp <- boxplot( log( bias_pmodel * flue_est_nls ) ~ insoilmbin, data=ddf, col="springgreen", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, at=(soilmbins[1:nbins]+1/nbins*0.7), boxwex=0.03, axes=FALSE, xlim=c(0,1) )
abline( h=0.0, lty=3 )
```
...
## add estimated fLUE to ddf
ddf <- ddf %>% mutate( flue_est_nls_binned = stress_quad_1sided_alpha( soilm_mean, meanalpha, coef(nlsfit)[[ "x0" ]], coef(nlsfit)[[ "apar" ]], coef(nlsfit)[[ "bpar" ]] ) )

bp <- boxplot( log( bias_pmodel ) ~ insoilmbin, data=ddf, col="tomato", las=1, outline = FALSE, na.rm=TRUE, add=FALSE, at=(soilmbins[1:nbins]+1/nbins*0.3), boxwex=0.05, xlim=c(0,1) )
bp <- boxplot( log( bias_pmodel * flue_est_2step ) ~ insoilmbin, data=ddf, col="royalblue3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, at=(soilmbins[1:nbins]+1/nbins*0.6), boxwex=0.02, axes=FALSE, xlim=c(0,1) )
bp <- boxplot( log( bias_pmodel * flue_est_nls ) ~ insoilmbin, data=ddf, col="springgreen", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, at=(soilmbins[1:nbins]+1/nbins*0.7), boxwex=0.02, axes=FALSE, xlim=c(0,1) )
bp <- boxplot( log( bias_pmodel * flue_est_nls_binned ) ~ insoilmbin, data=ddf, col="springgreen3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, at=(soilmbins[1:nbins]+1/nbins*0.8), boxwex=0.02, axes=FALSE, xlim=c(0,1) )
abline( h=0.0, lty=3 )
```
...
save( linearfit2, file="linearfit2.Rdata" )

## plot fLUE0 vs. mean alpha
plot_linearfit2( linearfit2, df=NULL )

## add estimated fLUE to ddf
ddf <- ddf %>% mutate( flue_est_linearfit2 = stress_quad_1sided_alpha( soilm_mean, meanalpha, x0_fix, coef(linearfit2$linmod)[["(Intercept)"]], coef(linearfit2$linmod)[["meanalpha"]] ) )
#ddf <- ddf %>% mutate( flue_est_linearfit2 = stress_quad_1sided_alpha( soilm_mean, meanalpha, x0_fix, -0.8, 1.8 ) )
...
bp2 <- boxplot( log( bias_pmodel * flue_est_2step ) ~ insoilmbin, data=ddf, col="royalblue3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, at=(soilmbins[1:nbins]+1/nbins*0.6), boxwex=0.02, axes=FALSE, xlim=c(0,1) )
bp3 <- boxplot( log( bias_pmodel * flue_est_nls ) ~ insoilmbin, data=ddf, col="springgreen", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, at=(soilmbins[1:nbins]+1/nbins*0.7), boxwex=0.02, axes=FALSE, xlim=c(0,1) )
bp4 <- boxplot( log( bias_pmodel * flue_est_linearfit2 ) ~ insoilmbin, data=ddf, col="springgreen3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, at=(soilmbins[1:nbins]+1/nbins*0.8), boxwex=0.02, axes=FALSE, xlim=c(0,1) )
abline( h=0.0, lty=3 )
```
...
## add estimated fLUE to ddf
ddf <- ddf %>% mutate( flue_est_nls_nsl2ratio = stress_quad_1sided_alpha( soilm_mean, meanalpha, x0_fix, coef(nlsfit)[[ "apar" ]], coef(nlsfit)[[ "bpar" ]] ) )

bp <- boxplot( log( bias_pmodel ) ~ insoilmbin, data=ddf, col="tomato", las=1, outline = FALSE, na.rm=TRUE, add=FALSE, at=(soilmbins[1:nbins]+1/nbins*0.3), boxwex=0.05, xlim=c(0,1) )
bp <- boxplot( log( bias_pmodel * flue_est_2step ) ~ insoilmbin, data=ddf, col="royalblue3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, at=(soilmbins[1:nbins]+1/nbins*0.6), boxwex=0.03, axes=FALSE, xlim=c(0,1) )
bp <- boxplot( log( bias_pmodel * flue_est_nls_nsl2ratio ) ~ insoilmbin, data=ddf, col="springgreen", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, at=(soilmbins[1:nbins]+1/nbins*0.7), boxwex=0.03, axes=FALSE, xlim=c(0,1) )
abline( h=0.0, lty=3 )
```
...
<!--   mycurve( function(x) calc_flue_est_alpha( x, meanalpha, apar=coef(linearfit2$linmod)[1], bpar=coef(linearfit2$linmod)[2], cpar=0.125, dpar=0.75 ), from=0.0, to=1.0, col='red', add=TRUE, lwd=2 ) -->
