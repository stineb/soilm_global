...
ddf <- ddf %>% mutate( infvarbin = cut( as.numeric(fvar), breaks = bins ) )

## Bias (difference), correction by fLUE directly, fLUE bins
bp1 <- boxplot( bias_pmodel_diff ~ infvarbin, data=ddf, col="tomato", las=1, outline = FALSE, na.rm=TRUE, add=FALSE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.1), boxwex=0.03, xlim=c(0,1), xlab="fLUE bins", ylab="bias (mod.-obs.)", staplewex=0, whisklty=1, ylim=c(-5,5) )
bp2 <- boxplot( bias_pmodel_diff_corr_e1 ~ infvarbin, data=ddf, col="springgreen3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.3), boxwex=0.03, xlim=c(0,1), axes=FALSE, staplewex=0, whisklty=1, ylim=c(-5,5) )
bp3 <- boxplot( bias_pmodel_diff_corr ~ infvarbin, data=ddf, col="springgreen4", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.5), boxwex=0.03, xlim=c(0,1), axes=FALSE, staplewex=0, whisklty=1, ylim=c(-5,5) )
abline( h=0.0, lty=3 )
...
## Bias (difference), correction by fLUE directly, fLUE bins
bp1 <- boxplot( bias_pmodel_diff ~ infvarbin, data=ddf, col="tomato", las=1, outline = FALSE, na.rm=TRUE, add=FALSE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.1), boxwex=0.03, xlim=c(0,1), xlab="fLUE bins", ylab="bias (mod.-obs.)", staplewex=0, whisklty=1, ylim=c(-5,5) )
bp2 <- boxplot( bias_pmodel_diff_corr_e2 ~ infvarbin, data=ddf, col="springgreen3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.3), boxwex=0.03, xlim=c(0,1), axes=FALSE, staplewex=0, whisklty=1, ylim=c(-5,5) )
bp3 <- boxplot( bias_pmodel_diff_corr ~ infvarbin, data=ddf, col="springgreen4", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.5), boxwex=0.03, xlim=c(0,1), axes=FALSE, staplewex=0, whisklty=1, ylim=c(-5,5) )
abline( h=0.0, lty=3 )
...
<!-- binwidth <- 1/nbins -->
<!-- bins <- seq( from=0, to=1, by=binwidth ) -->
<!-- ddf <- ddf %>% mutate( infvarbin = cut( as.numeric(fvar), breaks = bins ), insoilmbin = cut( as.numeric(soilm_mean), breaks = bins ) ) -->
...
## Bias (difference), correction by fLUE directly, fLUE bins
bp1 <- boxplot( bias_pmodel_diff ~ infvarbin, data=ddf, col="tomato", las=1, outline = FALSE, na.rm=TRUE, add=FALSE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.1), boxwex=0.03, xlim=c(0,1), xlab="fLUE bins", ylab="bias (mod.-obs.)", staplewex=0, whisklty=1, ylim=c(-5,5) )
bp2 <- boxplot( bias_pmodel_diff_corr_e4 ~ infvarbin, data=ddf, col="springgreen3", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.3), boxwex=0.03, xlim=c(0,1), axes=FALSE, staplewex=0, whisklty=1, ylim=c(-5,5) )
bp3 <- boxplot( bias_pmodel_diff_corr ~ infvarbin, data=ddf, col="springgreen4", las=1, outline = FALSE, na.rm=TRUE, add=TRUE, staplewex=0, whisklty=1, at=(bins[1:nbins]+1/nbins*0.5), boxwex=0.03, xlim=c(0,1), axes=FALSE, staplewex=0, whisklty=1, ylim=c(-5,5) )
abline( h=0.0, lty=3 )
...
<!-- plot_fit_vs_soilmoist( linearfit1, linearfit2, linearfit3, linearfit5, linearfit6, ddf, nice_agg ) -->
<!-- ``` -->
...
<!-- plot_fit_fvar_vs_time( linearfit1, linearfit2, linearfit3, linearfit5, ddf, nice_agg, makepdf = TRUE ) -->
<!-- ``` -->
...
<!-- plot_fit_gpp_vs_time( linearfit1, linearfit2, linearfit3, linearfit5, ddf, nice_agg, makepdf=TRUE ) -->
<!-- ``` -->
...
## pmodel
par(las=1)
boxplot( bias_pmodel_diff ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-5,5) )
abline( h=0, lty=3 )
mtext( "P-model", line=0.5, adj = 0, font=2 )

## MODIS
boxplot( bias_modis_diff ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-5,5) )
abline( h=0, lty=3 )
mtext( "MODIS", line=0.5, adj = 0, font=2 )

## vpm
boxplot( bias_vpm_diff ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-5,5) )
abline( h=0, lty=3 )
mtext( "VPM", line=0.5, adj = 0, font=2 )

## bess_v1
boxplot( bias_bess_v1_diff ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-5,5) )
abline( h=0, lty=3 )
...
df_dday_8d_agg <- df_dday_8d_agg %>% as_tibble() %>%
                                     mutate(  
                                              ...
                                              bias_modis_diff_corr_e1   = gpp_modis   * flue_est_2 - gpp_obs,
                                              bias_vpm_diff_corr_e1     = gpp_vpm     * flue_est_2 - gpp_obs, 
                                              bias_bess_v1_diff_corr_e1 = gpp_bess_v1 * flue_est_2 - gpp_obs, 
                                              bias_pmodel_diff_corr_e1  = gpp_pmodel  * flue_est_2 - gpp_obs
                                            )
...
## pmodel
boxplot( bias_pmodel_diff_corr ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-5,5) )
abline( h=0, lty=3 )
...
# with( df_dday_8d_agg, heatscatter( fvar, bias_pmodel_diff_corr_e1, ylim = c(-6,6), xlim = c(0,1.2) ) )
# abline( h=0, lty=3 )

## MODIS
boxplot( bias_modis_diff_corr ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-5,5) )
abline( h=0, lty=3 )
mtext( "MODIS, norm., corr. fLUE", line=0.5, adj = 0, font=2 )

## vpm
boxplot( bias_vpm_diff_corr ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-5,5) )
abline( h=0, lty=3 )
mtext( "VPM, norm., corr. fLUE", line=0.5, adj = 0, font=2 )

## bess_v1
boxplot( bias_bess_v1_diff_corr ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-5,5) )
abline( h=0, lty=3 )
mtext( "BESS, norm., corr. fLUE", line=0.5, adj = 0, font=2 )


## Corrected by estimated fLUE (following approach I)

## pmodel
boxplot( bias_pmodel_diff_corr_e1 ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-5,5) )
abline( h=0, lty=3 )
mtext( "P-model, norm., corr. II", line=0.5, adj = 0, font=2 )

## MODIS
boxplot( bias_modis_diff_corr_e1 ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-5,5) )
abline( h=0, lty=3 )
mtext( "MODIS, norm., corr. II", line=0.5, adj = 0, font=2 )

## vpm
boxplot( bias_vpm_diff_corr_e1 ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-5,5) )
abline( h=0, lty=3 )
mtext( "VPM, norm., corr. II", line=0.5, adj = 0, font=2 )

## bess_v1
boxplot( bias_bess_v1_diff_corr_e1 ~ inbin, data=df_dday_8d_agg, xlab = "fLUE bin", ylab = "bias (mod.-obs.)", outline=FALSE, ylim=c(-5,5) )
abline( h=0, lty=3 )
...
##------------------------------------------------
tmp0 <- df_dday_8d_agg %>%  select( mysitename, date, dday, inst, fvar, inbin, bias_modis_diff, bias_vpm_diff, bias_bess_v1_diff, bias_pmodel_diff) %>% 
                            gather( model, bias_diff, bias_modis_diff, bias_vpm_diff, bias_bess_v1_diff, bias_pmodel_diff )

tmp1 <- df_dday_8d_agg %>%  select( mysitename, date, dday, inst, fvar, inbin, bias_modis_diff_corr, bias_vpm_diff_corr, bias_bess_v1_diff_corr, bias_pmodel_diff_corr ) %>% 
                            gather( model, bias_diff_corr, bias_modis_diff_corr, bias_vpm_diff_corr, bias_bess_v1_diff_corr, bias_pmodel_diff_corr )

tmp2 <- df_dday_8d_agg %>%  select( mysitename, date, dday, inst, fvar, inbin, bias_modis_diff_corr_e1, bias_vpm_diff_corr_e1, bias_bess_v1_diff_corr_e1, bias_pmodel_diff_corr_e1 ) %>% 
...
##------------------------------------------------
par(las=1)
boxplot( bias_diff ~ inbin, data = df_dday_8d_agg_pooled, outline=FALSE, ylim=c(-7,7), xlab = "fLUE bin", ylab = "ratio obs./mod." )
abline( h=0, lty=3 )
mtext( "Pooled models, normalised", line=0.5, adj = 0, font=2 )

boxplot( bias_diff_corr ~ inbin, data = df_dday_8d_agg_pooled, outline=FALSE, ylim=c(-7,7), xlab = "fLUE bin", ylab = "ratio obs./mod." )
abline( h=0, lty=3 )
mtext( "Pooled models, norm., corr. fLUE", line=0.5, adj = 0, font=2 )

boxplot( bias_diff_corr_e1 ~ inbin, data = df_dday_8d_agg_pooled, outline=FALSE, ylim=c(-7,7), xlab = "fLUE bin", ylab = "ratio obs./mod." )
abline( h=0, lty=3 )
