...
save( ampl, file="data/ampl_jung.Rdata" )
...
with( ampl_agg, plot( resnr, relvar_q99, type="l", col="grey90", lwd=2 ) )
with( ampl_agg, lines(resnr, relvar_q95, type="l", col="grey80", lwd=2 ) )
with( ampl_agg, lines(resnr, relvar_q75, type="l", col="grey70", lwd=2 ) )
with( ampl_agg, lines(resnr, relvar_median, type="l", col="grey50", lwd=2 ) )
abline( h = 1.0, lty=3 )
